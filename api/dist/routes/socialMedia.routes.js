 ...
 * @access  Protected (Influencer)
 */
router.get('/tiktok/auth', protect, socialMediaController.initiateTikTokAuth.bind(socialMediaController));
/**
 ...
 */
router.get('/tiktok/callback', socialMediaController.tiktokCallback.bind(socialMediaController));
/**
 ...
 * @access  Protected (Influencer)
 */
router.get('/accounts', protect, socialMediaController.getConnectedAccounts.bind(socialMediaController));
/**
 * @route   DELETE /api/v1/social-media/:platform
 * @desc    Disconnect a social media account
 * @access  Protected (Influencer)
 */
router.delete('/:platform', protect, socialMediaController.disconnectAccount.bind(socialMediaController));
