...
class ProjectController {
    ...
    async createProject(req, res) {
        try {
            ...
            const { influencerId, title, projectType, description, startDate, endDate, budget, deliverables, requirements, location, category, } = req.body;
    ...
    async updateProject(req, res) {
        try {
            ...
            const { title, projectType, description, startDate, endDate, budget, deliverables, requirements, location, category, } = req.body;
            const updates = {};
            if (title !== undefined)
                updates.title = title;
            ...
            if (deliverables !== undefined)
                updates.deliverables = Array.isArray(deliverables) ? deliverables : [deliverables];
