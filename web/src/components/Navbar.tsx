        ...
        <div className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-20">
            ...
            >
              ...
              {/* Hover glow */}
              <motion.div
                className="absolute inset-0 -z-10 rounded-2xl bg-gradient-to-r from-pink-500 to-fuchsia-500 opacity-0 group-hover:opacity-20 blur-xl"
                initial={{ scale: 0 }}
            ...
            >
              ...
              <div className="sticky top-0 bg-gradient-to-br from-pink-50 to-fuchsia-50 p-6 border-b border-pink-200">
                <div className="flex items-center justify-between mb-4">
                  <div className="flex items-center gap-2">
                    <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-pink-600 to-fuchsia-600 flex items-center justify-center">
                      <FaRocket className="text-white text-lg" />
                    </div>
                    <div>
                      <div className="text-lg font-black bg-gradient-to-r from-pink-600 to-fuchsia-600 bg-clip-text text-transparent">
                        Beautiful
                      </div>
                      <div className="text-xs font-bold text-gray-500">ENCER</div>
                    </div>
                  </div>
                  ...
                  <motion.button
                    onClick={() => setIsOpen(false)}
                    whileTap={{ scale: 0.9 }}
                    className="w-10 h-10 rounded-xl bg-white flex items-center justify-center text-gray-800 hover:bg-pink-100 transition-colors"
                  >
