...
class AdminController {
    ...
    async getUsers(req, res) {
        try {
            const { page = '1', limit = '20', search = '', role, verified, sortBy = 'createdAt', sortOrder = 'desc', } = req.query;
    ...
    async suspendUser(req, res) {
        try {
            ...
            await adminService.logActivity({
                ...
                adminName: 'Admin',
                adminEmail: 'superadmin@realmedia.com',
                targetUserId: userId,
    ...
    async createUser(req, res) {
        try {
            ...
            const { name, email, password, phoneNumber, role, bio, region, businessName, description } = req.body;
            // Validation
    ...
    async updateUser(req, res) {
        try {
            ...
            const { id } = req.params;
            const { name, email, phoneNumber, bio, region, businessName, description } = req.body;
    ...
    async getProjectStats(req, res) {
        try {
            ...
            const influencerIds = topInfluencers.map(i => i.influencerId).filter((id) => id !== null);
