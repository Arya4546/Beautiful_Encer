...
import { FiGrid, FiBarChart2, FiTrendingUp, FiTag, FiClock, FiHeart, FiMessageCircle } from 'react-icons/fi';
                ...
                >
                  ...
                  {post.type && (
                    <div className="absolute top-2 right-2 bg-black/60 backdrop-blur-sm text-white text-[10px] sm:text-xs px-2 py-1 rounded-full font-semibold">
                      {post.type === 'Sidecar' ? 'Gallery' : post.type}
                    </div>
                  )}
                </a>
              ))
          ...
          <div className="grid grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-6">
            ...
            <div className="bg-gradient-to-br from-blue-50 to-blue-100 rounded-xl sm:rounded-2xl p-3 sm:p-6 border-2 border-blue-200">
              <div className="flex items-center justify-between mb-2 sm:mb-4">
                <h4 className="font-semibold text-gray-700 text-xs sm:text-sm">Average Likes</h4>
              ...
              <p className="text-[10px] sm:text-sm text-blue-600 mt-1 sm:mt-2">per post</p>
            </div>
            ...
            <div className="bg-gradient-to-br from-purple-50 to-purple-100 rounded-xl sm:rounded-2xl p-3 sm:p-6 border-2 border-purple-200">
              <div className="flex items-center justify-between mb-2 sm:mb-4">
                <h4 className="font-semibold text-gray-700 text-xs sm:text-sm">Avg Comments</h4>
              ...
              <p className="text-[10px] sm:text-sm text-purple-600 mt-1 sm:mt-2">per post</p>
            </div>

            {/* Engagement Rate */}
            <div className="bg-gradient-to-br from-pink-50 to-pink-100 rounded-xl sm:rounded-2xl p-3 sm:p-6 border-2 border-pink-200">
              <div className="flex items-center justify-between mb-2 sm:mb-4">
                <h4 className="font-semibold text-gray-700 text-xs sm:text-sm">Engagement</h4>
              ...
              <p className="text-[10px] sm:text-sm text-pink-600 mt-1 sm:mt-2">overall</p>
            </div>
            ...
            <div className="bg-gradient-to-br from-green-50 to-green-100 rounded-xl sm:rounded-2xl p-3 sm:p-6 border-2 border-green-200">
              <div className="flex items-center justify-between mb-2 sm:mb-4">
                <h4 className="font-semibold text-gray-700 text-xs sm:text-sm">Total Posts</h4>
              ...
              <p className="text-[10px] sm:text-sm text-green-600 mt-1 sm:mt-2">published</p>
            </div>
            ...
            <div className="bg-gradient-to-br from-amber-50 to-amber-100 rounded-xl sm:rounded-2xl p-3 sm:p-6 border-2 border-amber-200">
              <div className="flex items-center justify-between mb-2 sm:mb-4">
                <h4 className="font-semibold text-gray-700 text-xs sm:text-sm">Followers</h4>
              ...
              <p className="text-[10px] sm:text-sm text-amber-600 mt-1 sm:mt-2">total</p>
            </div>
            ...
            <div className="bg-gradient-to-br from-indigo-50 to-indigo-100 rounded-xl sm:rounded-2xl p-3 sm:p-6 border-2 border-indigo-200">
              <div className="flex items-center justify-between mb-2 sm:mb-4">
                <h4 className="font-semibold text-gray-700 text-xs sm:text-sm">Following</h4>
              ...
              <p className="text-xl sm:text-3xl font-bold text-indigo-700">
                {(() => {
                  ...
                  return followingCount > 0 ? followingCount.toLocaleString() : 'Hidden';
                })()}
              </p>
              <p className="text-[10px] sm:text-sm text-indigo-600 mt-1 sm:mt-2">
                {(() => {
                  const followingCount = account?.followingCount || metadata?.followingCount || 0;
                  return followingCount > 0 ? 'accounts' : 'by user';
                })()}
              </p>
            </div>
          </div>
          ...
          <div className="space-y-3 sm:space-y-4">
            ...
            <div className="bg-gradient-to-r from-magenta/5 to-purple/5 border-2 border-magenta/20 rounded-xl p-3 sm:p-4">
              <div className="flex items-start gap-2 sm:gap-3">
                ...
                <div>
                  <h4 className="font-bold text-gray-900 text-sm sm:text-base mb-1">Top Hashtags</h4>
                  <p className="text-xs sm:text-sm text-gray-600 leading-relaxed">
                    These are the most frequently used hashtags extracted from this influencer's recent posts. 
                    Hashtags help understand content themes and reach specific audiences on Instagram.
                  </p>
                </div>
              </div>
            </div>
            ...
            {topHashtags.length > 0 ? (
              ...
              <div className="text-center py-8 sm:py-12 text-gray-500">
                ...
                <p className="text-sm sm:text-base font-semibold mb-2">No Hashtags Found</p>
                <p className="text-xs sm:text-sm text-gray-400">This influencer hasn't used hashtags in their recent posts</p>
              </div>
            )}
          </div>
        )}
