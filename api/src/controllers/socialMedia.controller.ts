...
class SocialMediaController {
  ...
  async getPublicTikTokData(req: Request, res: Response) {
    try {
      const userId = req.user?.userId;
      if (!userId) {
        return res.status(401).json({ 
  ...
  async disconnectPublicTikTok(req: Request, res: Response) {
    try {
      const userId = req.user?.userId;
      if (!userId) {
        return res.status(401).json({ 
  ...
  // ===========================
  async connectYouTube(req: Request, res: Response) {
    try {
      const userId = req.user?.userId;
      if (!userId) {
        return res.status(401).json({ 
  ...
  // YOUTUBE - DISCONNECT
  // ===========================
  async disconnectYouTube(req: Request, res: Response) {
    try {
      const userId = req.user?.userId;
      if (!userId) {
        return res.status(401).json({ 
  ...
  // TWITTER/X - CONNECT
  // ===========================
  async connectTwitter(req: Request, res: Response) {
    try {
      const userId = req.user?.userId;
      if (!userId) {
        return res.status(401).json({ 
  ...
  // TWITTER/X - SYNC
  // ===========================
  async syncTwitter(req: Request, res: Response) {
    try {
      const userId = req.user?.userId;
      if (!userId) {
        return res.status(401).json({ 
  ...
  // TWITTER/X - GET DATA
  // ===========================
  async getTwitterData(req: Request, res: Response) {
    try {
      const userId = req.user?.userId;
      if (!userId) {
        return res.status(401).json({ 
  ...
  // ===========================
  async disconnectTwitter(req: Request, res: Response) {
    try {
      const userId = req.user?.userId;
      if (!userId) {
        return res.status(401).json({ 
