...
class AdminService {
    ...
    async getDashboardStats() {
        const [totalUsers, totalInfluencers, totalSalons, totalConnections, pendingConnections, acceptedConnections, totalMessages, totalInstagramAccounts, totalTikTokAccounts, verifiedUsers, unverifiedUsers, completedOnboarding,] = await Promise.all([
            // Total users
